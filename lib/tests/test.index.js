...
describe('toWei', function () {
  it('should handle edge cases', function () {
    ...
    assert.equal(units.toWei('.3', 'cip').toString(10), '300000000000000000');
    assert.throws(function () {
      return units.toWei('.', 'wei');
    }, Error);
    assert.throws(function () {
      return units.toWei('1.243842387924387924897423897423', 'cip');
    }, Error);
    assert.throws(function () {
      return units.toWei('8723.98234.98234', 'cip');
    }, Error);
  });
  ...
  it('should return the correct value', function () {
    ...
    assert.equal(units.toWei(1, 'cip').toString(10), '1000000000000000000');
...
describe('fromWei', function () {
  ...
  it('should return the correct value', function () {
    ...
    assert.equal(units.fromWei(1000000000000000000, 'cip'), '1');
